...
{ ?>
      ...
      if ( $data = mysqli_fetch_assoc( $result ) ) 
	     ?>
							<form enctype="multipart/form-data" class="form-detail" action="selectSubject.php" method="POST" id="myform">
								<div class="form-left">
                     ...
                     ?>
						...
						?>
							...
							<i class="zmdi zmdi-chevron-down"></i>
								...
								<div class="form-row">
								<input type="tel" name="contactNumber" id="ContactNumber" class="input-text" placeholder="Contact Number: 9xxxxxxxxx" maxlength="10" required> 
								</div>
									</div>
									<div class="form-right">
										<br>
